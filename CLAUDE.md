...
| feeds/mail_scan.py (ATS/LinkedIn-notification + tracked-company reply scan; skill `mail-scan`; consent-gated by data/mail_scan_enabled) | email_messages, contact_events, suggestions (create/expire), company_domains (seed), run_log — NEVER opportunities.* |
